...
private:
    ...
    double DA_rate = 0.1;       // Dearness Allowance rate (10%)
    double HRA_rate = 0.15;     // HRA rate (15%)
    double medical_allowance_rate = 0.05;  // Medical Allowance rate (5%)
    double professional_tax = 200;          // Fixed professional tax
    double overtime_rate = 50;              // Per hour overtime rate
